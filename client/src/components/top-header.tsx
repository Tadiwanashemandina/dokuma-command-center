 ...
 *
 * The bar carries no location cue of its own: the sidebar already marks the
 * active section, and each page states its own name in the heading.
 */
export function TopHeader({ user }: { user: CurrentUser }) {
  return (
    <header className="sticky top-0 z-20 flex h-[72px] shrink-0 items-center justify-end border-b border-border/70 bg-white/70 px-6 backdrop-blur sm:px-8">
